...
$query = mysqli_query($connection, "insert into t_pembayaran set pesanan='$pesanan', id_pesanan='$id_pesanan', biaya='$biaya', tgl_pembayaran='$tgl_pembayaran', bukti_pembayaran='$bukti_pembayaran'");
if ($query) {
  $_SESSION['info'] = [
    'status' => 'success',
